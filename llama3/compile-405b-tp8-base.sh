...
# Base llama 405b compilation script. This is intended to be invoked by other scripts.
# Usage:
# ./compile-405b-tp8-base.sh <iree-compile-path> <gfxip> <input mlir> -o <output vmfb> [extra flags]
